...
public class ChangeLogRepositoryImpl implements ChangeLogCustomRepository {
  ...
  private OrderSpecifier<?> createOrderSpecifier(String sortField, String sortDirection) {
    ...
    PathBuilder<ChangeLog> path = new PathBuilder<>(ChangeLog.class, QChangeLog.changeLog.getMetadata());
    ...
    return switch (sortField) {
      ...
      case "changedAt", "at" -> new OrderSpecifier<>(order, path.getDate("changedAt", LocalDate.class));
